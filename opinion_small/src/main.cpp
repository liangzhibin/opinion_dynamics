...
int main(int argc, char *argv[]) {
    ...
    int opt;
    const char *opt_string = "a:b:g:l:m:s:";
    ...
    Network network(graph_file, log_path, load_setup, manual_seed);

    switch(algorithm) {
        case 'g':
//            cout << "algorithm: batch gradient greedy " << endl;
            network.batch_gradient_greedy_inv(batch_size, budget, log_path);
            break;
        case 'm':
//            cout << "algorithm: marginal greedy " << endl;
            network.marginal_greedy_inv(budget, log_path);
            break;
        case 'r':
//            cout << "algorithm: random node selection " << endl;
            network.random_batch_inv(batch_size, budget, log_path);
            break;
        default:
